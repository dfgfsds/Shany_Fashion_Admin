                          ...
                          {data?.data?.payment_status !== 'unpaid' && (
                            <div className="mt-4">
                              {(data?.data?.status !== 'Delivered' && data?.data?.status !== 'Cancelled/Refunded' && data?.data?.status !== 'Shipment Failed' && data?.data?.status !== 'Failed') && (
                                <button
                                  className='bg-red-500 p-2 text-white rounded-md hover:bg-[#B69339]'
                    ...
                    {showRefundForm && (
                      <div className="mt-4 p-4 bg-gray-50 rounded-lg border">
                        ...
                        <div className="mt-1 flex justify-end gap-2">
                          <button
                            className='bg-red-500 p-2 text-white rounded-md hover:bg-[#B69339]' onClick={() => setShowRefundForm(false)}>Cancel</button>
