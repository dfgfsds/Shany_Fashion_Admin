            ...
            <div className="bg-white w-full max-w-lg mx-auto rounded-lg p-3 shadow-lg max-h-[90vh] overflow-y-auto scrollbar-hide">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <>
                            ...
                            {fields?.map((item: any, index) => (
                                <>
                                    ...
                                    <button type="button" onClick={() => remove(index)} className="text-white bg-[#B69339] rounded-md text-sm ml-auto p-1 m-2"><X /></button>
                    ...
                    <div className="mt-5 flex justify-end space-x-2">
                        ...
                        <button
                            type="submit"
                            className="bg-[#B69339] text-white px-4 py-2 rounded"
                            disabled={loading}
