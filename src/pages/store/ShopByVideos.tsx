        ...
        <div className="p-6 bg-white shadow-md rounded-lg">
            <div className="flex justify-between items-center mb-4">
                ...
                <button
                    ...
                    className="bg-[#B69339] text-white hover:bg-[#A37F30] px-4 py-2 rounded-lg "
                >
                    + Add Video
                </button>
            </div>
                                ...
                                <tr key={video.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-2 border text-center space-x-2">
                                        ...
                                        <button
                                            ...
                                            className="bg-red-500 text-white px-3 py-1 rounded-md hover:bg-[#B69339] transition"
                                        >
                                            Delete
                                        </button>
                                    </td>
                    ...
                    <div className="bg-white w-full max-w-md rounded-lg shadow-lg p-6 relative">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <div className="flex justify-end gap-3 mt-4">
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2 bg-[#B69339] text-white hover:bg-[#A37F30] rounded-lg "
                                >
