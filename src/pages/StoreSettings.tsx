        ...
        <div className="mt-8">
          ...
          <div className='flex justify-between mb-3'>
            ...
            <button
              ...
              className="flex gap-2 mt-5  px-4 py-2 bg-[#B69339]  text-white rounded-lg hover:bg-[#A37F30] "
            >
          ...
          <div className="border-t pt-6">
            <div className='flex justify-between mb-3'>
              ...
              {(vendorSiteDetails?.vendor_site_details?.delivery_partner || vendorSiteDetails?.vendor_site_details?.delivery_partner_client_id) && (
                <button
                  className='bg-[#B69339] text-white px-4 py-2 rounded-lg hover:bg-[#A37F30] flex items-center gap-2'
                  onClick={() => {
            ...
            {vendorSiteDetails?.vendor_site_details?.delivery_partner || vendorSiteDetails?.vendor_site_details?.delivery_partner_client_id || vendorSiteDetails?.vendor_site_details?.own_courier_company_id ?
              (
                ...
                <div className='flex justify-center '>
                  <button className=' gap-2 bg-[#B69339] text-white px-4 py-2 rounded-lg hover:bg-[#A37F30]'
            ...
            <div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              <div>
                ...
                <div className="mt-5 sm:mt-6 flex justify-end space-x-2">
                  ...
                  <button
                    className="bg-[#B69339] hover:bg-[#A37F30]-300 text-white px-4 py-2 rounded"
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40 flex items-center justify-center">
          <div className="bg-white w-full max-w-lg mx-auto rounded-lg p-6 shadow-lg  max-h-[90vh] overflow-y-auto scrollbar-hide">
            ...
            <div className="mt-5 flex justify-end space-x-2">
              ...
              <button
                className="bg-[#B69339] text-white px-4 py-2 rounded hover:bg-[#A37F30]"
          ...
          >
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              <button
                ...
                disabled={loading}
                className="px-4 py-2 bg-[#B69339] text-white rounded-md text-sm font-medium hover:bg-[#A37F30] gap-2 flex"
              >
